...
public final class CryptoUtilities {
    ...
    public static boolean isWitnessToCompositeness(NaturalNumber w,
        ...
        return (wCopy.equals(one) || !w.equals(one));
    }
    ...
    public static boolean isPrime2(NaturalNumber n) {
        ...
        if (n.compareTo(new NaturalNumber2(THREE)) <= 0) {
            ...
            for (int i = 1; i < 50; i++) {
                ...
                /*
                 * The random number generator produces 1's and 0's, and
                 * (n-1)'s, which violate the asserts in
                 * isWitnessToCompositeness. So produce a new random number
                 * whenever the generator violates those asserts
                 */
    ...
    public static void generateNextLikelyPrime(NaturalNumber n) {
        ...
        /*
         * if the number is even, increment it to an odd number, because all
         * even numbers higher than 2 are composite
         */
        if (isEven(n)) {
            n.increment();
        }
