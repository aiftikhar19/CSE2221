...
public class SortingMachine4<T> extends SortingMachineSecondary<T> {
    ...
    public final void changeToExtractionMode() {
        ...
        // change this.insertionMode to false and sort this.entries
    ...
    public final T removeFirst() {
        ...
        // remove item from front of this.entries and return it
    ...
    public final int size() {
        ...
        // return the length of this.entries
