...
public final class Statement1Parse1 extends Statement1 {
    ...
    public void parse(Queue<String> tokens) {
        ...
        //Using if/else instead of case/switch because only 3 cases
    ...
    public void parseBlock(Queue<String> tokens) {
        ...
        //this must be replaced according to contract
        this.clear();

        String nextToken = tokens.front();
        int pos = 0;

        //According to CFG, statement begins with identifier, if, or while
