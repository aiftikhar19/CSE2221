...
public class JCFExplorationsTest {
    ...
    @Test
    public final void testGiveRaiseOSUExample2() {
        /* Setup */
        components.map.Map<String, Integer> m = this.mapCreateFromArgsOSU(
                "Annie", "500", "aliyah", "1600", "sam", "5", "Fail", "75");
        components.map.Map<String, Integer> mExpected = this
                .mapCreateFromArgsOSU("Annie", "500", "aliyah", "1760", "sam",
                        "5", "Fail", "75");
        /* The Call */
        JCFExplorations.giveRaise(m, 'a', 10);
        /* Evaluation */
        assertEquals(mExpected, m);
    }
