...
public abstract class MapTest {
    ...
    public final void testAddToNonEmpty() {
         ...
         * Set up variables
         */
        Map<String, String> test = this.createFromArgsTest("key1", "value1",
                "key0", "value0");
        Map<String, String> ref = this.createFromArgsRef("key1", "value1",
                "key0", "value0");
        /*
         * Call method under test
         */
    ...
    public final void testRemoveAnyToEmpty() {
        ...
        assertTrue(ref.hasKey(testRemoved.key()));
    ...
    /*
     * Tests value; possible challenge case, multiple keys have same value
     */
    @Test
    public final void testValueDuplicateValue() {
        /*
         * Set up variables
         */
        Map<String, String> test = this.createFromArgsTest("key", "value",
                "testkey", "value", "testkey1", "testvalue1");
        Map<String, String> ref = this.createFromArgsRef("key", "value",
                "testkey", "value", "testkey1", "testvalue1");
        /*
         * Call method under test
    ...
    /*
     * Tests hasKey; boundary case, Map size =0 (false)
     */
    @Test
